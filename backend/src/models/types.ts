export interface Plan { ID: number; Model: string; Qty: number; FUpdateDate: string; LineID?: number }
export interface HourlyQty { ID: number; PID: number; PQty: number; MQty?: number | null; AQty?: number | null }
export interface LineInfo { id: number; lineModel: string }
